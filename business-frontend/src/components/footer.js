export function renderFooter() {
    const linkClasses = "text-text-tertiary hover:text-white transition-colors group inline-flex items-center";
    const externalLinkIcon = `<svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-3.5 w-3.5 ml-1 text-gray-500 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
    </svg>`;

    return `
        <div class="bg-dark-surface border-t border-text-tertiary/20">
            <div class="container mx-auto px-6 py-16">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    <div class="col-span-2 lg:col-span-2">
                         <a href="/" class="flex items-center gap-2">
                            <img src="/logo.png?v=2" alt="Lumen Logo" class="h-8 w-8">
                            <span class="font-bold text-xl text-white">Lumen</span>
                        </a>
                        <p class="mt-4 text-text-tertiary max-w-xs">The strategic data advantage for world-class AI.</p>
                    </div>
                    <div>
                        <h3 class="font-semibold text-primary tracking-wider uppercase text-sm">Product</h3>
                     ...
                     <div>
                        <h3 class="font-semibold text-primary tracking-wider uppercase text-sm">Company</h3>
                        <ul class="mt-4 space-y-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-primary tracking-wider uppercase text-sm">Legal</h3>
                        <ul class="mt-4 space-y-3">
                ...
                <div class="mt-16 pt-8 border-t border-text-tertiary/20 text-sm text-text-tertiary text-center">
