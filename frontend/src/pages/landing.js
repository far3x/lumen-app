            ...
            <div class="container mx-auto px-6">
                <div class="shadow-lg border-2 border-[#C4C4C4] mx-auto grid md:grid-cols-2 items-center overflow-hidden relative h-96 rounded-lg transition-all duration-300 ease-in-out hover:scale-102 hover:shadow-xl">
                    ...
                    <div class="text-left p-12 relative">
                        ...
                        <a href="${startEarningUrl}" class="mt-8 inline-block px-8 py-3 font-bold bg-red-600 text-white hover:bg-red-700 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 ease-out">Claim your spot</a>
                </div>
            </div>
        </div>
    </section>
