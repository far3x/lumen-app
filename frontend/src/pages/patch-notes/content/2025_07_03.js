export function renderContent() {
    return `
        ...
        <ul>
            ...
            <li><strong>1,000 $LUMEN Genesis Bonus:</strong> As a thank you, the first 200 users who gain access will receive a <strong>1,000 $LUMEN bonus</strong> on top of their normal reward for their first successful contribution.</li>
        </ul>
