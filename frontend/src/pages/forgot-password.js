...
function render() {
    ...
    container.innerHTML = `
        <h1 class="text-3xl font-bold text-text-main">Forgot Password?</h1>
        ...
        <form id="forgot-password-form" class="mt-6 space-y-4">
            <div>
                ...
                <input id="email" name="email" type="email" autocomplete="email" required
                       class="block w-full bg-primary border border-subtle rounded-md px-3 py-3 text-text-main focus:ring-2 focus:ring-accent-primary focus:outline-none"
        ...
        <div class="min-h-screen flex items-center justify-center p-6">
            <div class="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
                <div class="w-full max-w-md mx-auto text-center">
                    <div id="forgot-password-container" class="bg-surface p-8 rounded-xl border border-primary shadow-2xl shadow-black/5">
                    </div>
                     <p class="mt-6 text-center text-sm">
                        <a href="/login" class="font-medium text-accent-primary hover:underline">Back to Login</a>
                    </p>
                </div>
