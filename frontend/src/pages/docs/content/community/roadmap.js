export const renderRoadmap = () => `
    ...
    <p class="lead text-xl text-text-secondary">Our vision is to build the definitive data layer for the next generation of AI. This is a multi-year journey, executed in distinct phases, moving from a foundational data network to an intelligent software development ecosystem.</p>
    ...
    <div class="mt-8 space-y-12 relative border-l-2 border-primary pl-8">
        ...
        <div class="relative">
            ...
            <p class="text-sm font-bold text-accent-purple">PHASE 1: THE FOUNDATION (NOW)</p>
        ...
        <div class="relative">
            ...
            <p class="text-sm font-bold text-accent-pink">PHASE 2: THE ECOSYSTEM (FUTURE)</p>
        ...
        <div class="relative">
            ...
            <p class="text-sm font-bold text-accent-cyan">THE FUTURE: THE LUMEN AGENT</p>
            <h3 id="the-lumen-agent" class="text-xl font-bold mt-1">From Data Layer to Intelligent Agent</h3>
            <p class="text-text-secondary mt-1">Focus: Leverage our unique, high-signal dataset to build a category-defining AI developer tool.</p>
            <p class="text-text-secondary mt-2">Our ultimate vision extends beyond simply being a data provider. The dataset we are building is the perfect fuel to create a new class of AI software engineer. We are building the <strong>Lumen Agent</strong>.</p>
            <p class="text-text-secondary mt-2">The Lumen Agent will be an AI that takes the entire context of a codebase to execute complex tasks. It won't just suggest a line of code; it will understand architecture, dependencies, and business logic to perform tasks like refactoring entire services, implementing complex features from high-level specifications, and writing comprehensive test suites. This is the ultimate expression of our mission: turning the code of today into the tools of tomorrow.</p>
            <blockquote>Beyond the Agent, our vision extends into new data verticals and decentralized AI infrastructure, creating a comprehensive ecosystem for the future of intelligence. The journey is just beginning.</blockquote>
        </div>
    </div>
`;