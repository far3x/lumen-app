export const renderCoreCommands = () => `
    ...
    <div class="space-y-4 mt-8">
        ...
        <div class="bg-surface border border-primary rounded-lg p-4">
            <code class="font-mono text-accent-cyan text-base">lum history</code>
    ...
    <div class="space-y-4 mt-8">
        <div class="bg-surface border border-primary rounded-lg p-4">
            <code class="font-mono text-accent-cyan text-base">lum local [path]</code>
        ...
        <div class="bg-surface border border-primary rounded-lg p-4">
            <code class="font-mono text-accent-cyan text-base">lum local -g <URL></code>
        ...
        <div class="bg-surface border border-primary rounded-lg p-4">
            <code class="font-mono text-accent-cyan text-base">lum local -t <filename></code>
         ...
         <div class="bg-surface border border-primary rounded-lg p-4">
            <code class="font-mono text-accent-cyan text-base">lum local -l [number]</code>
