export const renderWhitepaper = () => `
    ...
    <ul>
        <li><strong>Genesis Contributor Program:</strong> Launch the beta to onboard the first 500 developers, deploying the initial reward pool and building our foundational dataset.</li>
        <li><strong>Secure Strategic Launch Partners:</strong> We are in discussions with established developer communities and platforms like Believe App to ensure a successful launch and immediate, high quality supply.</li>
