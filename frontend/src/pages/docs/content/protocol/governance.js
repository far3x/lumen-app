export const renderGovernance = () => `
    ...
    <p>The LIP process is designed to be transparent and collaborative:</p>
    <ol>
    ...
    <h2 id="areas-of-governance">Areas of Governance</h2>
    <p>Token holders will have control over the most critical aspects of the protocol, including:</p>
    <ul>
        <li><strong>Protocol Upgrades:</strong> Approving significant changes to the valuation engine, anonymization process, or core smart contracts.</li>
        <li><strong>Fee Mechanics:</strong> Adjusting the percentage of fees taken on data sales that go to the Treasury, stakers, or are burned.</li>
        <li><strong>Treasury Allocation:</strong> Voting on how to spend funds from the community-controlled Treasury, such as funding developer grants, marketing campaigns, or strategic partnerships.</li>
        <li><strong>Reward Parameters:</strong> Making adjustments to the Epoch halving schedule or other contributor reward mechanisms.</li>
    </ul>

    <h2 id="progressive-decentralization">The Path to Progressive Decentralization</h2>
    <p>True decentralization cannot be achieved overnight. It is a deliberate, phased process. In the early stages, the core Lumen team will act as stewards of the protocol, guiding development and ensuring stability. However, with each phase of the roadmap, more power and responsibility will be transferred to the community.</p>
    <blockquote>Our success will be measured not by our control over the protocol, but by our ability to make ourselves obsolete, leaving behind a thriving, self-sustaining, community-owned data economy.</blockquote>
`;