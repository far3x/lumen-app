    ...
    const modalContent = `
        <div class="text-center">
            ...
            <div class="flex justify-center gap-4">
                ...
                <button id="referral-confirm-btn" class="px-6 py-2 bg-accent-primary hover:bg-red-700 text-white font-medium rounded-md transition-colors">Confirm</button>
            </div>
        </div>
    `;
...
export function renderReferralPage() {
    return `
        <div class="flex flex-col flex-grow items-center justify-center min-h-[60vh] bg-surface rounded-lg border border-primary text-center p-8">
            <div class="max-w-xl">
                <h1 class="text-5xl font-bold mb-4">
                    <span class="text-text-main">Grow the Network.</span>
                    <br>
                    <span class="text-accent-primary">Grow Your Rewards.</span>
                </h1>
                ...
                <button id="notify-referral-btn" class="mt-8 px-8 py-3 font-bold bg-accent-primary text-white rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/20 hover:bg-red-700">
