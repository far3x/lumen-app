export const renderWhyLumen = () => `
    <h1 id="the-lumen-advantage">The Lumen Advantage</h1>
    ...
    <ul>
        <li><strong>Tangible Rewards:</strong> Contribute your anonymized code and earn real-world value. Rewards are calculated in USD and paid out daily in USDC, a stablecoin pegged 1:1 to the US Dollar, directly to your Solana wallet.</li>
